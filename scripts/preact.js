        ...
        null == (k = l[h]) || 'boolean' == typeof k
          ...
          : 'string' == typeof k || 'number' == typeof k || 'bigint' == typeof k
            ...
            : Array.isArray(k)
              ...
              : k.__b > 0
                ? v(k.type, k.props, k.key, k.ref ? k.ref : null, k.__v)
                : k)
    ) {
  ...
  try {
    n: if ('function' == typeof T) {
      ...
      (h.state = h.__s),
        ...
        w(n, Array.isArray(I) ? I : [I], u, i, t, o, r, f, e, c),
        (h.base = u.__e),
        (u.__h = null),
...
function L(l, u, i, t, o, r, e, c) {
  ...
  if (null === d) y === p || (c && l.data === p) || (l.data = p);
    ...
    if ((C(l, p, y, o, c), v)) u.__k = [];
      ...
      ((k = u.props.children),
      w(l, Array.isArray(k) ? k : [k], u, i, t, o && 'foreignObject' !== d, r, e, r ? r[0] : i.__k && _(i, 0), c),
      null != r)
    )
